...
export type { DefineCustomSource, DefineCustomMap, DefinedIcons, Filled, IconConfig, OpticalSize, SymbolKey, SymbolSvg, Theme, Weight, } from './src/tooling/registry';
export { syncMaterialSymbols, syncMaterialSymbolsInternal } from './src/tooling/sync';
export type { SyncMaterialSymbolsOptions, SyncMaterialSymbolsInternalOptions, SyncMaterialSymbolsInternalResult, } from './src/tooling/sync';
