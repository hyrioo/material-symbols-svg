...
export type { DefineCustomSource, DefineCustomMap, DefinedIcons, Filled, IconConfig, OpticalSize, SvgFileSource, SymbolKey, SymbolSvg, Theme, Weight, } from './src/tooling/registry';
